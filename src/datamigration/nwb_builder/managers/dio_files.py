...
class DioFiles:
    ...
    def get_dio_files(self):
        multiple_datasets_dio_files = [self.__get_dio_dict(dataset) for dataset in self.directories]
        filtered_datasets_dio_files = self.__filter_dio_files(multiple_datasets_dio_files, self.dio_metadata)
        return filtered_datasets_dio_files

    @classmethod
    def __filter_dio_files(cls, multiple_datasets_dio_files, dio_metadata):
    ...
    @classmethod
    def __get_dio_dict(cls, directory):
        dio_dict = {}

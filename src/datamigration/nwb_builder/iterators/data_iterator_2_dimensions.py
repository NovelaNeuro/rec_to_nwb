...
class DataIterator2Dimensions(AbstractDataChunkIterator):
    ...
    def __init__(self, data):
        ...
        self.number_of_steps = self.__get_num_steps(data)
    ...
    @staticmethod
    def __get_num_steps(data):
        return data.num_datasets * data.single_dataset_len
    ...
    def __get_dataset_file_length(data):
        return data.file_lenghts

    @staticmethod
    def __get_number_of_rows(data):
        return data.num_rows_per_file

    @staticmethod
    def __get_number_of_files_in_single_dataset(data):
        return data.single_dataset_len
    ...
    def __next__(self):
        if self.__current_index < self.number_of_steps:
            ...
            data_chunk = DataChunk(data=data_from_file,
                              selection=selection)

...
class TestElectrodeAddendum(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.electrode_addendum.electrodes_counter = self.electrodes_counter
    ...
    def test_electrode_addendum(self):
        ...
        self.assertEqual(self.electrode_addendum.electrodes_counter, self.electrodes_counter)

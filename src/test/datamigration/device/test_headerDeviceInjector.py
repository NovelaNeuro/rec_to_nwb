...
class TestHeaderDeviceInjector(TestCase):
    ...
    def test_injectHeaderDevice_correctValuesInjected_true(self):
        ...
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_smart_ref_on, 'Sample headstage_smart_ref_on')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].realtime_mode, 'Sample realtime_mode')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_auto_settle_on, 'Sample headstage_auto_settle_on')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].timestamp_at_creation, 'Sample timestamp_at_creation')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].controller_firmware_version, 'Sample controller_firmware_version')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].controller_serial, 'Sample controller_serial')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].save_displayed_chan_only, 'Sample save_displayed_chan_only')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_firmware_version, 'Sample headstage_firmware_version')
        ...
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_gyro_sensor_on, 'Sample headstage_gyro_sensor_on')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_mag_sensor_on, 'Sample headstage_mag_sensor_on')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].trodes_version, 'Sample trodes_version')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].headstage_accel_sensor_on, 'Sample headstage_accel_sensor_on')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].commit_head, 'Sample commit_head')
        self.assertEqual(self.nwb_content.devices['HeaderDevice1'].system_time_at_creation, 'Sample system_time_at_creation')

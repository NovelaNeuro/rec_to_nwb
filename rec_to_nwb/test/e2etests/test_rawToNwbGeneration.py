...
_DEFAULT_TRODES_REC_EXPORT_ARGS = ('-reconfig', str(path) + '/../test_data/KF2/raw/20170120/20170216_kibbles_reconfig2.xml')
...
class TestRawToNWBGeneration(unittest.TestCase):
    ...
    def setUp(self):
        self.metadata = MetadataManager(
            str(path) + '/../test_data/KF2/raw/20170120/kibbles20170216_metadata.yml',
            [
                str(path) + '/../test_data/KF2/raw/20170120/64c-3s6mm6cm-20um-40um-sl.yml',
                str(path) + '/../test_data/KF2/raw/20170120/64c-4s6mm6cm-20um-40um-dl.yml'
            ]
        )

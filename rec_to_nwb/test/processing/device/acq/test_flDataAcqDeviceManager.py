...
class TestFlDataAcqDeviceManager(TestCase):
    ...
    def test_fl_data_acq_device_manager_create_successfully_without_optional_data(self):
        metadata = [
            {'name': 'dataacq_device0', 'system': 'system_0', 'amplifier': 'amplifier_0', 'adc_circuit': 'adc_circuit_0'},
            {'name': 'dataacq_device1', 'system': 'system_1', 'amplifier': 'amplifier_1', 'adc_circuit': 'adc_circuit_1'}
        ]
        ...
        self.assertEqual(fl_data_acq_device[0].name, 'dataacq_device0')
        ...
        self.assertEqual(fl_data_acq_device[1].name, 'dataacq_device1')
    ...
    def test_fl_data_acq_device_manager_create_successfully_with_optional_data(self):
        metadata = [
            {'name': 'dataacq_device0', 'system': 'system_0', 'amplifier': 'amplifier_0', 'adc_circuit': 'adc_circuit_0'},
            {'name': 'dataacq_device1', 'system': 'system_1'}
        ]

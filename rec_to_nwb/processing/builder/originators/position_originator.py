...
from rec_to_nwb.processing.nwb.components.position.fl_position_manager import \
    FlPositionManager
from rec_to_nwb.processing.nwb.components.position.position_creator import \
    PositionCreator
...
class PositionOriginator:
    ...
    def __init__(self, datasets: list, metadata: dict, dataset_names: list,
        ...
        self.pm_creator = ProcessingModuleCreator(

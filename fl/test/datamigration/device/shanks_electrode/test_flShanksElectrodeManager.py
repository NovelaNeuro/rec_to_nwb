...
class TestFlShanksElectrodeManager(TestCase):
    ...
    def test_fl_shanks_electrode_manager_create_fl_shank_successfully(self):
        ...
        probes_metadata_1 = {'probe_type': 'tetrode_12.5', 'contact_size': 20.0, 'num_shanks': 1, 'shanks': [
        ...
        probes_metadata_2 = {'probe_type': '128c-4s8mm6cm-20um-40um-sl', 'contact_size': 20.0, 'num_shanks': 4,
                                  'shanks': [
                                      {'shank_id': 0, 'electrodes': [
        ...
        fl_shanks_elecrodes_dict = fl_shanks_electrode_manager.get_fl_shanks_electrodes()

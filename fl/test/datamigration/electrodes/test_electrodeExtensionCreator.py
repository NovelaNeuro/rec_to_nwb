...
class TestElectrodeExtensionsCreator(TestCase):
    ...
    def test_electrode_extension_creator_build_extensions_successfully(self):
        ...
        electrodes_metadata_extension, electrodes_header_extension, ntrodes_extension_ntrode_id, \
            ntrodes_extension_bad_channel = electrode_extension_creator.create()
        ...
        self.assertIsNotNone(ntrodes_extension_bad_channel)
        self.assertEqual(ntrodes_extension_bad_channel[0], True)
        self.assertEqual(ntrodes_extension_bad_channel[-1], False)
